...
const createThunk = (type: string, messageType: string, transformer: any = null) =>
    createAsyncThunk(
        type,
        async (
            {
...
const createGenericThunk = (type: string) =>
    createAsyncThunk(
        type,
        async (
            {
...
const sessionSlice = createSlice({
    ...
    reducers: {
        ...
        addPiece: (state, action) => {
            ...
            state.closet.pieces.unshift(newPiece); 
        },
        ...
        updateFit: (state, action) => {
            const updatedFit = action.payload; 
        ...
        updateFitColl: (state, action) => {
            const updatedFitColl = action.payload; 
